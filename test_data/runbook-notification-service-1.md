...
The service runs on Celery and uses Rust for storage.
...
### Issue 2: Retry storm after upstream timeout
...
3. Page Henrik Larsen if issue persists after rollback
