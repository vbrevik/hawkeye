...
This document describes the design for Project Phoenix. The goal is to review and rotate all secrets in Vault
in a way that is scalable, maintainable, and observable.

## Problem Statement

Currently, payment-processor suffers from goroutine leak in the WebSocket handler.
...
2. user-service validates the token using RabbitMQ
